          ...
          <StyledView className="items-center mb-4">
            ...
            {isEditing ? (              <>
                ...
                <StyledView className="w-full mb-4">
                  ...
                  <StyledTextInput 
                    className={`border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-md p-2 w-full bg-gray-100`}
                ...
                <StyledView className="w-full mb-4">
                  ...
                  <StyledTextInput 
                    className={`border ${errors.phoneNumber ? 'border-red-500' : 'border-gray-300'} rounded-md p-2 w-full`}
                  ...
                  />
                  {errors.phoneNumber && (
                    <StyledText className="text-red-500 text-xs mt-1">{errors.phoneNumber}</StyledText>
                  )}
                </StyledView>
                ...
                {user?.phoneNumber && (
                  <StyledText className="text-gray-500 mt-1">
                    <Ionicons name="call-outline" size={14} color="#666" /> {user.phoneNumber}
                  </StyledText>
                )}
