...
const GroupDetailsScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    } else if (activeTab === 'members' && !groupMembers?.length) {
      fetchMembers();
    }
      ...
      <>
        ...
        <ScrollView style={styles.scrollView}>
          ...
          <View style={[styles.tabContent, { display: activeTab === 'info' ? 'flex' : 'none' }]}>
            ...
            {/* Members Tab */}          
          <View style={[styles.tabContent, { display: activeTab === 'members' ? 'flex' : 'none' }]}>
            <View style={styles.card}>
              <Text style={styles.cardTitle}>Members</Text>
              <Text style={styles.cardText}>Members section is being reimplemented.</Text>
              
              <TouchableOpacity 
                style={styles.primaryButton}
                onPress={() => fetchMembers()}
              >
                <Text style={styles.buttonText}>Refresh Members Data</Text>
              </TouchableOpacity>
            </View>
          </View>
            {/* Finances Tab */}
