...
namespace GameFundManager.API.Controllers
{
    ...
    public class AuthController : BaseApiController
    {
        ...
        [SwaggerResponseExample(200, "{\"success\":true,\"message\":\"User information retrieved\",\"data\":{\"id\":\"3fa85f64-5717-4562-b3fc-2c963f66afa6\",\"username\":\"johndoe\",\"email\":\"john@example.com\",\"firstName\":\"John\",\"lastName\":\"Doe\",\"phoneNumber\":\"1234567890\",\"profilePictureUrl\":null},\"errors\":null}")]        public async Task<IActionResult> GetCurrentUser()
        {
