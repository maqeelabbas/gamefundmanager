...
public interface IGroupService
{
    ...
    Task<ApiResponse<bool>> DeleteGroupAsync(Guid id, Guid userId);
    Task<ApiResponse<IEnumerable<GroupMemberDto>>> GetGroupMembersAsync(Guid groupId);
    Task<ApiResponse<GroupMemberDto>> AddMemberToGroupAsync(AddGroupMemberDto memberDto, Guid userId);
