...
public class ContributionService : IContributionService
{
    ...
    public async Task<ApiResponse<IEnumerable<ContributionDto>>> GetGroupContributionsByUserAsync(Guid groupId, Guid userId)
    {
        var group = await _groupRepository.GetByIdAsync(groupId);
        ...
        var contributions = await _contributionRepository.GetGroupContributionsByUserAsync(groupId, userId);
        var contributionDtos = _mapper.Map<IEnumerable<ContributionDto>>(contributions);
